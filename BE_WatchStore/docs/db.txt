...
-- Cập nhật khóa ngoại manager_id trong bảng Store
ALTER TABLE Store ADD COLUMN manager_id INTEGER REFERENCES Employee(id);
...
CREATE TABLE FooterLink (
    id SERIAL PRIMARY KEY,
    category_id INTEGER REFERENCES FooterCategory(id),
    title VARCHAR(255) NOT NULL,
...
-- Function để cập nhật thời gian sửa đổi
...
-- Function để tạo slug cho sản phẩm
...
-- Function để giảm số lượng tồn kho khi đơn hàng hoàn tất
...
-- Function để tăng số lượng tồn kho khi phiếu nhập hoàn tất
...
-- Function để tính tồn kho theo thời gian
...
-- Function tính doanh số bán hàng theo nhân viên
...
-- Function báo cáo sản phẩm dưới ngưỡng tồn kho
