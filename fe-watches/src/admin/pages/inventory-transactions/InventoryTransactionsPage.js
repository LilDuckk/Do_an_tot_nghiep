...
const InventoryTransactionsPage = () => {
  ...
  const fetchTransactions = useCallback(async () => {
    ...
    try {
      ...
      if (debouncedSearchText && debouncedSearchText.trim()) paramsObj.search = debouncedSearchText.trim();
      ...
      console.log('Current state:', { currentPage, pageSize, debouncedSearchText, transactionType, referenceType, dateRange });
  ...
  }, [debouncedSearchText, transactionType, referenceType, dateRange, currentPage, pageSize, setCurrentPage]);
  ...
  const handleSearchChange = (e) => {
    ...
    // Hook useDebounceSearch sẽ tự động reset page khi search thay đổi
  };
