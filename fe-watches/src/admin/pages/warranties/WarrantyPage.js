...
const WarrantyPage = () => {
  ...
  const debouncedCustomerPhone = useDebounce(customerPhone, 300);
  ...
  }, [debouncedSearchText, statusFilter, dateRange, selectedOrder, selectedProduct, debouncedCustomerName, debouncedCustomerPhone, currentPage, pageSize, setCurrentPage]);
